...
negWords = {"acı", "alerji", "arızalanmak", "açgözlülük", "ağlamak", "âciz", "acımak", "ağrımak", "asla", "aksatmak", "aksamak",
            "berbat", "boğmak",  "boşuna", "boş", "burukluk", "bozmak", "bozuk", "bozulmak", "bağımlı", "beter", "bozgun",
            "cimri", "cahil",
            "çatışma", "çirkin", "çarpmak", "çökmek",
            "değil", "donmak", "dövmek", "düşük", "dayanılmaz", "değillemek", "düşmek",
            "eksilmek", "ezmek", "endişe",
            "fena", "felç", "fahiş",
            "gergin", "göçmek", "gerilemek",
            "hüzün", "hata", "hasta", "hiçbir", "hiç",
            "intihar", "iğrenç", "istifa", "itici", "iptal",
            "kavga", "kaybetmek", "kaybol", "kayıp", "kokain", "korkunç",  "kötü", "kırmak", "kırık", "kaza", "küflenmek", "kesmek", "kaçırmak", "korku", "kötülük", "kınamak", "kanamak", "kıskanç", "kötümser",
            "lanet",
...
conWords = {"ama", "fakat", "lakin", "ancak", "için", "hatta", "henüz", "dolayı", "sonucunda", "neyse"}
